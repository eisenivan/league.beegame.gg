        ...
        loading
          ...
          : (
            <CenterContent>
              ...
              <p className='-mt-4 mb-4 text-xs'>As team captain, understand that registering a team means you will be expected to work with another team captain to schedule a match EVERY WEEK for up to 11 weeks this season. Make sure you read the Help section for Rules and Guidance.</p>
              <FormBox>
